...
| 操作类型 | 对话命令示例 | 功能说明 |
|---------|-------------|---------|
| **一键安装全部** | `"从 https://github.com/2426366814/trae-skills-hub 安装所有推荐技能"` | 从指定仓库安装所有推荐的 skills 和 MCP |
| **按项目类型** | `"我开发了 React 项目，安装相关技能"` | 根据项目类型智能安装 |
| **按 GitHub 仓库** | `"我克隆了 https://github.com/xxx/yyy，安装相关技能"` | 分析任意仓库技术栈后安装 |
...
| **查看已安装** | `"查看已安装技能"` | 显示所有已安装技能 |
| **卸载技能** | `"卸载 docx 技能"` | 卸载指定技能 |
